...
export const Home = () => {
  return (
    <div className="min-h-screen bg-[#0f0a07] text-[#f3e5ab]">
      ...
      {/* Hero / Início */}
      <header id="inicio" className="min-h-[85vh] flex flex-col items-center justify-start pt-1 px-4 pb-6 md:p-12 md:justify-center text-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#2d1911] via-[#120a06] to-[#0f0a07] relative overflow-hidden">
